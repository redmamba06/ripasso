...
export const SHORTCUTS: ShortcutDef[] = [
  ...
  { id: 'draw', label: 'Inserisci disegno / attiva la matita', group: 'Disegno a mano', def: 'Mod+Shift+D' },
  { id: 'drawFormula', label: 'Inserisci formula a mano', group: 'Disegno a mano', def: 'Mod+Shift+F' },
  ...
  { id: 'drawFull', label: 'Disegno a schermo intero', group: 'Disegno a mano', def: 'Alt+F', hint: 'mentre disegni' },
  { id: 'drawDone', label: 'Fine disegno', group: 'Disegno a mano', def: 'Escape', hint: 'mentre disegni' },
  { id: 'toLatex', label: 'Converti disegno in formula LaTeX', group: 'Disegno a mano', def: 'Alt+M', hint: 'mentre disegni' },
